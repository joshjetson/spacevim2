...
#=============================================================================
# install.sh --- bootstrap script for SpaceVim2
# Copyright (c) 2016-2022 Shidong Wang & Contributors
# Original author: Shidong Wang < wsdjeg@outlook.com >
# Adapted for SpaceVim2: https://github.com/joshjetson/spacevim2
# License: GPLv3
#=============================================================================
...
fetch_repo () {
    ...
    if [[ -d "${XDGSpaceDir:-}" ]]; then
        ...
        git clone --depth 1 https://github.com/joshjetson/spacevim2.git "${XDGSpaceDir:-}"
...
# usage {{{
usage () {
    echo "SpaceVim2 install script : V ${Version}"
    echo ""
    echo "Usage : curl -sLf https://raw.githubusercontent.com/joshjetson/spacevim2/master/install.sh | bash -s -- [option] [target]"
    echo ""
    echo "  This is the bootstrap script for SpaceVim2."
    echo ""
    echo "OPTIONS"
    echo ""
    echo " -i, --install            install SpaceVim2 for vim or neovim"
    echo " -v, --version            Show version information and exit"
    echo " -u, --uninstall          Uninstall SpaceVim2"
    echo " -c, --checkRequirements  checkRequirements for SpaceVim2"
    echo " --no-fonts               skip downloading fonts"
    echo ""
    echo "EXAMPLE"
    echo ""
    echo "    Install SpaceVim2 for vim and neovim"
    echo ""
    echo "        curl -sLf https://raw.githubusercontent.com/joshjetson/spacevim2/master/install.sh | bash"
    echo ""
    echo "    Install SpaceVim2 for vim only or neovim only"
    echo ""
    echo "        curl -sLf https://raw.githubusercontent.com/joshjetson/spacevim2/master/install.sh | bash -s -- --install vim"
    echo "        curl -sLf https://raw.githubusercontent.com/joshjetson/spacevim2/master/install.sh | bash -s -- --install neovim"
    echo ""
    echo "    Uninstall SpaceVim2"
    echo ""
    echo "        curl -sLf https://raw.githubusercontent.com/joshjetson/spacevim2/master/install.sh | bash -s -- --uninstall"
}
# }}}
...
install_done () {
    ...
    echo_with_color ${Yellow} "=============================================================================="
    echo_with_color ${Yellow} ""
    echo_with_color ${Yellow} "That's it. Thanks for installing SpaceVim2. Enjoy!"
    echo_with_color ${Yellow} ""
}
# }}}
...
welcome () {
    ...
    echo_with_color ${Yellow} "               | ##                                                           "
    echo_with_color ${Yellow} "               |__/                                                           "
    echo_with_color ${Yellow} "                      version : ${Version}      by : spacevim2             "
}
# }}}
